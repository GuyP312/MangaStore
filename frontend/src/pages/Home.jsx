...
import MangasCard from '../components/home/MangasCard';
import MangasTable from '../components/home/MangasTable';
  ...
  return (
    <div className='p-4'>
      ...
      {loading ? (<Spinner />) : ( showType ==='table' ?
        (<MangasTable mangas={mangas}/>) : (<MangasCard mangas = {mangas}/>) //HOLY TERNARY INSIDE A TERNARY
      )}
    </div>
  )
}
